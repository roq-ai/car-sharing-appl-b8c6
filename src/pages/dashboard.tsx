...
import { useRoqPlatformUserProfiles, useBookingCount, useCarCount, useCarModelCount } from 'lib/roq';

import { CarMaintenanceListPage as ShowCaseList } from 'pages/car-maintenances';
...
function DashboardPage() {
  ...
  const carModelStat = useCarModelCount();
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Car Maintenances
                </Text>
                <NextLink href={`car-maintenances`} passHref legacyBehavior>
                  <Button
