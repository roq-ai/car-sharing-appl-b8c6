...
export function CarListPage(props: CarListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'booking.count', 'car_maintenance.count', 'review.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('car_maintenance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'car_maintenance',
          header: 'Car Maintenance',
          accessorKey: 'car_maintenance',
          cell: ({ row: { original: record } }: any) => record?._count?.car_maintenance,
        }
      : null,
