...
import { useRoqClient, useCarModelFindManyWithCount } from 'lib/roq';
...
export function CarModelListPage(props: CarModelListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useCarModelFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.car_model.delete({ where: { id } });
      await mutate();
    } catch (error) {
